/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 1fd91ed6f29a6e0ea1ac654cfaa300bf)
// Runtime types generated with workerd@1.20260811.1 2026-08-16 
interface __BaseEnv_CloudflareBindings {
	MESSENGER: DurableObjectNamespace<import("./src/index").Messenger>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Messenger";
	}

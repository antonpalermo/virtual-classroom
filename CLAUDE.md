...
- `apps/worker-oidc` (`@capstone/openid-connect`) — Better Auth basics (email/password, D1 via Drizzle); not yet an OIDC provider/client. See [apps/worker-oidc/CLAUDE.md](apps/worker-oidc/CLAUDE.md).
